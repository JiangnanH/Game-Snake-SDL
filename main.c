...
void init(void)
{
    ...
    sound_eat = Mix_LoadMUS("./music/eat.wav");
    sound_mine = Mix_LoadMUS("./music/mine.wav");
    sound_hit = Mix_LoadMUS("./music/hit.wav");
    sound_ghost = Mix_LoadMUS("./music/ghost.mp3");
    sound_missile = Mix_LoadMUS("./music/missile.mp3");
    sound_hit_m = Mix_LoadMUS("./music/hit_m.mp3");
    sound_over = Mix_LoadMUS("./music/over.mp3");
    ...
    fruit1_surface = SDL_LoadBMP("./texture/fruit1.bmp");
    fruit2_surface = SDL_LoadBMP("./texture/fruit2.bmp");
    fruit3_surface = SDL_LoadBMP("./texture/fruit3.bmp");
    fruit4_surface = SDL_LoadBMP("./texture/fruit4.bmp");
    mine_surface = SDL_LoadBMP("./texture/mine.bmp");
    ghost_surface = SDL_LoadBMP("./texture/ghost.bmp");
    wall_surface = SDL_LoadBMP("./texture/wall.bmp");
    missile_surface = SDL_LoadBMP("./texture/missile.bmp");
    sheade_surface = SDL_LoadBMP("./texture/heade.bmp");
    sheadse_surface = SDL_LoadBMP("./texture/headse.bmp");
    sheads_surface = SDL_LoadBMP("./texture/heads.bmp");
    sheadsw_surface = SDL_LoadBMP("./texture/headsw.bmp");
    sheadw_surface = SDL_LoadBMP("./texture/headw.bmp");
    sheadnw_surface = SDL_LoadBMP("./texture/headnw.bmp");
    sheadn_surface = SDL_LoadBMP("./texture/headn.bmp");
    sheadne_surface = SDL_LoadBMP("./texture/headne.bmp");
    snake_surface = SDL_LoadBMP("./texture/body.bmp");
    field_surface = SDL_LoadBMP("./texture/field.bmp");
